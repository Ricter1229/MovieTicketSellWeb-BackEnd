...
public class MovieController {
	...
	@PostMapping("/find")
	public MovieResponse find(@RequestBody String entity) {
		long count = movieService.count(entity);
        List<MovieBean> products = movieService.find(entity);
        return new MovieResponse(count, products, false, "");
	}
...
//    }
	...
	public MovieResponse findById(@PathVariable Integer id) {
	    ...
	    return new MovieResponse(0, products, success, message);
	}
